    ...
    <div className="min-h-screen">
      ...
      <div className="py-6 px-4">
        ...
        <div className="bg-white p-2 mb-6">
          <div className="mb-8">
            <h2 className="text-gray-800 font-bold text-lg mb-2">
              최근 평균 섭취량과 비교한 <br />
              <span className="text-gray-800">변화율</span>입니다.
            </h2>
        ...
        >
          ...
          <p className={`leading-relaxed ${warningStyle.contentColor}`}>{warningContent}</p>
        </div>

        {/* 하단 설명 */}
        <div className="bg-white rounded-lg p-2">
          <h3 className="text-gray-800 font-bold text-lg mb-4">왜 연속적인 섭취량 증감이 중요한가요?</h3>
